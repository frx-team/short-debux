    		...
    		function mulshortgoo() {
    			if(countprocess < c) {
    				$.get("https://www.shareaholic.com/v2/share/shorten_link?apikey=8943b7fd64cd8b1770ff5affa9a9437b&service[name]=" + attr + "&url=" + b[countprocess], function(response) {
    				    document.getElementById("urlshort").value +="https://l.instagram.com/?u=" + b[countprocess] + "&e=" + cuk + "&s=1" + "\n";
    				    document.getElementById("urldebug").value += "https://www.instagram.com/linkshim/?u=" + b[countprocess] + "&e=" + cuk + "&s=1" + "\n";
    				    document.getElementById("urldebux").value += "https://l.facebook.com/l.php?u=" + b[countprocess] + "&h=" + makeid(25) + "&s=1" + "\n";
    					countprocess++;
    					document.getElementById("loding").innerHTML = countprocess;
    					setTimeout(function(){
    						mulshortgoo();
...
function frxdiv(attrdiv) {
    if(attrdiv == 'defaultinput') {
        ...
        document.getElementById("debuxinput").setAttribute("class", "btn btn-default btn-xs");
        ...
        document.getElementById("input-debux").setAttribute("style", "display: none;");
    ...
    } else if(attrdiv == 'debuxinput') {
        document.getElementById("defaultinput").setAttribute("class", "btn btn-default btn-xs");
        document.getElementById("debuginput").setAttribute("class", "btn btn-default btn-xs");
        document.getElementById("debuxinput").setAttribute("class", "btn btn-success btn-xs");
        document.getElementById("input-default").setAttribute("style", "display: none;");
        document.getElementById("input-debug").setAttribute("style", "display: none;");
        document.getElementById("input-debux").setAttribute("style", "");
    }
}
